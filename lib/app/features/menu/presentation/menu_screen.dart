...
import 'package:mega/app/features/menu/presentation/widgets/custom_grey_card.dart';
              ...
              body: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    RowSection(
                      onTap: () {
                        final cachedState = context
                            .read<GetCachedDataCubit>()
                            .state;

                        if (cachedState is GetCachedDataLoaded) {
                          Navigator.pushNamed(
                            context,
                            RouteNames.profileScreen,
                            arguments: cachedState.cachedData,
                          );
                        } else {
                          showCustomSnackBar(
                            context,
                    ...
                    RowSection(
                      onTap: () => _showLogoutConfirmation(innerContext),
                      title: AppLocalizations.of(innerContext)!.logout,
